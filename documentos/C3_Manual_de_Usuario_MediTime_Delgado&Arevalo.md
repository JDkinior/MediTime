...
6. **Distintivos visuales y menú lateral unificado:** El cajón de navegación lateral (*Drawer*) expone la insignia destacada **`🐾 Modo Animales`** y unifica todos los iconos de las opciones al verde salvia y contenedores crema menta (exceptuando la opción de cierre de sesión en rojo), ofreciendo una experiencia inmersiva y coherente.
